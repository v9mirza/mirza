      ...
      {links.map((link) => {
        ...
        return (
          ...
          >
            ...
            <span className="ml-auto text-[11px] text-[#555c68] opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0.5 self-center flex-shrink-0">
              ↗
            </span>
          </a>
        )
